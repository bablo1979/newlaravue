...
let BackgroundColorTheif = function () {};
...
BackgroundColorTheif.prototype.getPalette = function (sourceImage, colorCount, quality) {
    ...
    let pixelCount;
    let widthLimit = Math.round(image.getWidth() * 0.1);
    let heightLimit = Math.round(image.getHeight() * 0.1);
    ...
    for (let i = (image.getHeight() - heightLimit) * image.getWidth(), offset, r, g, b, a; i < pixelCount; i = i + quality) {
        offset = i * 4;
        r = pixels[offset + 0];
        g = pixels[offset + 1];
        b = pixels[offset + 2];
    ...
    for (let i = heightLimit * image.getWidth(), offset, r, g, b, a, j = 0, k = 0; i < pixelCount; i = i + quality) {
        offset = i * 4;
        r = pixels[offset + 0];
        g = pixels[offset + 1];
        b = pixels[offset + 2];
    ...
    pixelCount = (image.getHeight() - heightLimit) * image.getWidth();
    for (let i = heightLimit * image.getWidth() + (image.getWidth() - widthLimit - quality), offset, r, g, b, a, j = 0, k = 0; i < pixelCount; i = i + quality) {
        offset = i * 4;
        r = pixels[offset + 0];
        g = pixels[offset + 1];
        b = pixels[offset + 2];
...
export default {
    BackgroundColorTheif: BackgroundColorTheif,
};
